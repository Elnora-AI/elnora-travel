...
const ALLOWED_EMAIL = /^(opensource@elnora\.ai|security@elnora\.ai|conduct@elnora\.ai|noreply@anthropic\.com)$/i;
...
const BANNED = [
  ...
  { name: "absolute Windows home path", re: /[A-Z]:\\Users\\([\w.-]+)\\/i, homeGroup: 1 },
  ...
  { name: "RapidAPI key shape", re: /\b[A-Za-z0-9]{8,}msh[A-Za-z0-9]{10,}jsn[A-Za-z0-9]{8,}\b/ },
  { name: "64-hex secret (SerpApi key shape)", re: /\b[a-f0-9]{64}\b/i },
